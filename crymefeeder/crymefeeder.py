...
class CrymeFeeder:
    ...
    def _batch_insert_incidents(self, get_records_func, batch_size, **kwargs):
        results_chunk = True
        page = 0
    ...
    def update_incident_records(self, batch_size):
        most_recently_created = self.db_most_recently_created_record
        self._batch_insert_incidents(
            self.data_source.get_incidents_created_after,
            batch_size,
            **{'dt': most_recently_created}
        )

    def populate_incidents(self, batch_size):
        self._batch_insert_incidents(self.data_source.get_incidents, batch_size)
